	...
	public static void main(String[] args) {
		//int[][] arr3=new int[3][]; 
				...
				case 4:
					...
					int[][] arrMax = Array2DService.MaximumNo(arr, arr1);
					Array2DService.displayData(arrMax);
					
					
					break;
				case 5:
					Array2DService.acceptData(arr);
					int[] arrRowMax=Array2DService.maximumRowwise(arr);
					for(int i : arrRowMax) {
				...
				case 6:
					Array2DService.acceptData(arr);
					int[] arrColMax=Array2DService.maximumcolumnWise(arr);
					for(int i : arrColMax) {
						System.out.println(i);
					}
					break;
